    ...
    return rx.el.a(
        ...
        rx.el.span(
            ...
            class_name=rx.cond(
                ...
                "hidden lg:inline lg:ml-3 lg:whitespace-nowrap lg:overflow-hidden",
            ),
        ),
        href=href,
        class_name=rx.cond(
    ...
    return rx.fragment(
        rx.el.aside(
            rx.el.div(
                rx.el.div(
                    rx.el.div(
                        ...
                        class_name=rx.cond(
                            ...
                            "hidden lg:block px-4 py-4 border-b border-gray-100",
                        ),
                    ),
                    rx.el.nav(
                        rx.el.div(
                ...
                class_name=rx.cond(
                    SidebarState.sidebar_visible,
                    "fixed inset-y-0 left-0 z-50 w-64 transition-all duration-300 ease-in-out transform translate-x-0 border-r border-gray-200",
                    "fixed inset-y-0 left-0 z-50 w-0 transition-all duration-300 ease-in-out transform -translate-x-full lg:translate-x-0 lg:w-64 lg:border-r lg:border-gray-200",
                ),
            )
        )
    )
    ...
    return rx.el.div(
        ...
        rx.el.div(
            rx.el.header(
                ...
                class_name=rx.cond(
                    SidebarState.sidebar_visible,
                    "fixed top-0 right-0 left-0 z-30 bg-white/80 backdrop-blur-md border-b border-gray-200 transition-all duration-300 pl-64",
                    "fixed top-0 right-0 left-0 z-30 bg-white/80 backdrop-blur-md border-b border-gray-200 transition-all duration-300 pl-0 lg:pl-64",
                ),
            ),
            rx.el.main(
                ...
                class_name=rx.cond(
                    ...
                    "min-h-screen transition-all duration-300 pl-0 lg:pl-64",
                ),
            ),
